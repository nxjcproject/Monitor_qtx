...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--标签粘贴处--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_17ALC_RN2>BoolSignal" style="position: absolute; top:546px; left: 1246px; height: 16px; right: 22px;" data-option="RelatedTags='Cement01_M_17ALC_RN2',Display='Display='00:yellowC,01:greenC'"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_LIA_04R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 309px; left: 256px; position:absolute;color:black;text-align:right;"></div>
        ...
        <%--汉字隐藏--%>
        <div id="zc_nxjc_qtx_efc>Cement01_PBSX>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 196px; left: 266px; color: #4cff00; text-align: center; height: 22px; right: 842px; bottom: 210px;">警告：配比≠%</div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_M_14ALC_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 490px; left: 1274px; color: #4cff00; text-align: center; height: 18px; right: -36px; bottom: 192px;">故障</div>
        <div id="zc_nxjc_qtx_efc>Cement01_M_17ALC_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 545px; left: 1279px; color: #4cff00; text-align: center; height: 18px; right: -37px; bottom: 137px;">故障</div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_G6M_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 175px; left: 562px; color: #4cff00; text-align: center; height: 22px; right: 683px; bottom: 249px;">报警</div>
        <div id="zc_nxjc_qtx_efc>Cement01_M_13M_AM>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 488px; left: 1021px; color: #4cff00; text-align: center; height: 22px; right: 180px; bottom: 213px;">综合故障</div>
