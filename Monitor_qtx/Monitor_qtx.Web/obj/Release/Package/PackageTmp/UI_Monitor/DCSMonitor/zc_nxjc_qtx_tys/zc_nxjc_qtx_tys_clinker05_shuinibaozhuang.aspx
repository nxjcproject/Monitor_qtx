    ...
    <script src="../../js/common/DCSMonitorShell.js"></script>
     ...
     <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_clinker05_shuinibaozhuang.png'); width: 1558px; height: 807px; overflow: hidden;">
       <%--<button onclick="CheckTags()">检查标签</button>--%>
         <%--模拟量--%>
         <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_B62007L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:33px; display:block; top:384px; left: 1130px;  position:absolute;color:blue;text-align:right; height: 16px;"></div>
         ...
         <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_BZZJC2_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px; display:block; top:332px; left: 531px;  position:absolute;color:blue;text-align:right; height: 16px;"></div>
         ...
         <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_BZZJC1_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:41px; display:block; top:334px; left: 149px;  position:absolute;color:blue;text-align:right; height: 16px;"></div>
         ...
         <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_BZZJC3_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:44px; display:block; top:355px; left: 1297px;  position:absolute;color:blue;text-align:right; height: 16px;"></div>
