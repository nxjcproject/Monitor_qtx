 ...
 <body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_clinker05_shuliaochucun.png'); width: 1558px; height: 834px; overflow: hidden;">
       <%--<button onclick="CheckTags()">检查标签</button>--%>
         ...
         <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_T34100L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:58px; display:block; top:200px; left: 762px;  position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
